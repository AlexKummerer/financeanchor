...
- Kredit-Plan: nur tatsächliche Zahlungen (Rate, Frist-Rate bzw. Zurücklegen, eigene `extraMonthlyCents`); Ziele werden nur geprüft. „Verfügbar für Kredite“ (`loanBudgetCents`) dient ausschließlich `loanAdvice` (Vorschläge) und ändert keinen Plan.
