...
CREATE TABLE `__new_loans` (
	...
	`extra_monthly_cents` integer DEFAULT 0 NOT NULL,
	...
	CONSTRAINT "loans_extra_ck" CHECK(extra_monthly_cents >= 0),
...
INSERT INTO `__new_loans`("id", "user_id", "created_at", "updated_at", "name", "kind", "balance_cents", "original_cents", "rate_bp", "payment_cents", "due_day", "target_month", "due_date", "payment_mode", "saved_cents") SELECT "id", "user_id", "created_at", "updated_at", "name", "kind", "balance_cents", "original_cents", "rate_bp", "payment_cents", "due_day", "target_month", "due_date", "payment_mode", "saved_cents" FROM `loans`;--> statement-breakpoint
